...
const USAGE_PRESETS = {
  ...
  "3": [
    ...
    { label: "朝・昼食後・寝る前", slots: ["morning", "noon", "bedtime"] },
    { label: "朝・夕食後・寝る前", slots: ["morning", "evening", "bedtime"] },
    { label: "昼・夕食後・寝る前", slots: ["noon", "evening", "bedtime"] },
  ],
  "4": [
